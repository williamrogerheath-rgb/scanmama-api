...
def process_document(image_bytes: bytes, options: ScanOptions) -> Dict:
    ...
    # Step 1: ML Document Detection (DocAligner)
    print("\n=== ML Detection (DocAligner) ===")
    detection_result = detect_ml(image)
    ...
    print(f"Detection: detected={document_detected}, confidence={detection_confidence:.3f}, method={detection_method}")
